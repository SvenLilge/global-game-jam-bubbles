...
func _ready():
	...
	await show_tutorial(1_1, Vector2(560, 340))
	await show_tutorial(1_2, Vector2(560, 840))
	await show_tutorial(1_3, Vector2(1360, 340))
	await show_tutorial(1_4, Vector2(1360, 840))
	await show_tutorial(1_5)
	player.start_tween();
